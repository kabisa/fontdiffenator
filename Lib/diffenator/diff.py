...
def cbdt_diff_script(font_before, font_after, diff_options,
    ...
    with contextlib.closing(ttLib.TTFont(font_before)) as ttf:
    ...
    with contextlib.closing(ttLib.TTFont(font_after)) as ttf:
    ...
    #     print(f"Codepoints set has changed: : {codepoints_set1 ^ codepoints_set2}")
    ...
    glyphs_after_h = glyphs2

    new = codepoints_set2 - codepoints_set1
    missing = codepoints_set1 - codepoints_set2
